...
export default function EngineeringLogPage() {
  ...
  return (
    <main id="main-content">
      ...
      <PageHero index="06" eyebrow="ENGINEERING LOG" title="Evidence before confidence." copy="Technical notes, architecture studies, development history, and explicit validation limits. Every article is dated when published—not backdated to make the project appear older." aside={<><span>PUBLIC ARTICLES</span><b>{String(engineeringArticles.length).padStart(2, "0")} ENTRIES</b><small>COMPILED 22 JULY 2026</small></>} />
